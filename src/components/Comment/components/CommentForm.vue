    ...
    <div class="form-box">
      <div class="rich-input" :class="{ focus: focus || value }">
        ...
        <div v-show="imgSrc" ref="image-preview-box" class="image-preview-box">
          <div
            v-show="imgSrc"
            :style="`background-image: url(${imgSrc+'?x-oss-process=image/auto-orient,1/quality,q_70/format,webp'})`"
            class="image"
          />
        ...
        <!-- @mousedown.prevent="closeEmojiSelector($refs.input.focus())"    v-show="focus || value || imgSrc" -->
      <div
      ...
      >
        ...
        <div class="image-btn" @mousedown.prevent.stop="triggerUpload">
          <svg
            aria-hidden="true"
            width="22"
            height="22"
          ...
          >
            <g fill="none" fill-rule="evenodd">
              ...
              <g transform="translate(2 3)">
                ...
                />
                <circle cx="13.5" cy="4.5" r="1.5" fill="#9E9EA0" />
              </g>
            </g>
          </svg>
          <!-- <span>图片</span> -->
...
import { MixinToken } from './tokenMixin'
...
export default {
  ...
  props: {
    placeholder: {
      type: String,
      default: 'Talk about your views on the project ~'
    },
    id: {
      type: [String, Number],
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      let userId,commentsId;
      if  ( this.comment && this.comment.userId && this.parent){
        userId = this.comment.userId 
        commentsId = this.comment.commentsId
      
      }else if( this.parent ) {
        userId = this.parent.userId 
        commentsId = this.parent.commentsId
      }else{
        userId = null;
        commentsId = null
      }
  ...
  .form-box {
    ...
    .option-box {
      ...
      .emoji {
        ...
        .emoji-box {
          ...
          .icon {
            ...
            background-repeat: no-repeat;
            background-size: cover;
            background-image: url('../../../assets/image/emojis.png');
      ...
      .submit-btn {
        ...
        background: linear-gradient(89deg, #ECB639 0%, #EE8A22 100%);
        border-radius: 20px;
        outline: none;
        border: none;
        cursor: pointer;
